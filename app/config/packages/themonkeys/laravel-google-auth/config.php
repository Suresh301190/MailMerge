...
return array(
    ...
    |
    */
    'clientId' => '1019432465859-24l9ne8ud0k2p6loao44qbosjvuvh8li.apps.googleusercontent.com',
    ...
    |--------------------------------------------------------------------------
    */
    'clientSecret' => 'MkkmWm2Wftv-2m4C-bLobqHr',
    ...
    |
    */
    'redirectUri' => URL::to('/') . '/home', // URL:to('/') doesn't include the trailing slash
